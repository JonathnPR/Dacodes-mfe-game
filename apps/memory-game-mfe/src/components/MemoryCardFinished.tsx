 ...
 * @param totalTime - Tiempo total en ms
 * @param tryCount - Número de intentos
 * @param onRestart - Callback para reiniciar el juego
 * @param onBack - Callback para volver a la selección
 */
type Props = {
	totalTime: number
	tryCount: number
	...
	return (
		<div className="text-center py-8">
			<div className="bg-gradient-to-r from-green-500/20 to-blue-500/20 border border-green-500/30 rounded-xl p-8 mb-6">
				...
				<p className="text-white/80 text-lg mb-4">¡Has completado el juego!</p>
				<div className="flex justify-center space-x-8 mb-6">
					<div className="text-white/90">
						<div className="text-lg font-semibold">Tiempo</div>
						<div className="text-2xl">{formatTime(totalTime)}</div>
					</div>
					<div className="text-white/90">
						<div className="text-lg font-semibold">Intentos</div>
				...
				<div className="flex justify-center space-x-4">
					<button
						...
						onClick={onBack}
					>
						<ArrowLeftCircle className="mr-2" size={20} /> Volver
					</button>
					<button
						className="flex items-center px-4 py-2 rounded-lg bg-white/10 text-white border border-white/20 hover:bg-white/20 hover:border-white/30 transition"
						onClick={onRestart}
