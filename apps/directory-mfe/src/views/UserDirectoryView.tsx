...
import { useUserDirectoryPaginated } from '../hooks/useUserDirectory'
...
export default function UserDirectoryView(): React.ReactNode {
	...
	const { data, isLoading } = useUserDirectoryPaginated(searchQuery, skip, USERS_PER_PAGE)
							...
							{!searchQuery && totalPages > 1 && (
								<div className="flex items-center justify-center">
									<button
										...
										className="px-4 py-2 bg-white/10 text-white border border-white/30 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-white/20 transition-colors"
									>
										Previous
									</button>
